...
Architecture Decision Records (ADRs) capture hard-to-reverse, non-obvious decisions and their
rationale. Each record is a short title followed by a concise explanation; changes are recorded
in a new ADR rather than by deleting the old one.
...
- [Defer Card collections](0006-defer-card-collections.md)
- [Use Leitner-lite scheduling](0007-use-leitner-lite-scheduling.md)
- [Derive Points from the Review log](0008-derive-points-from-review-log.md)
- [Treat offline grading as best-effort](0009-offline-grading-is-best-effort.md)
