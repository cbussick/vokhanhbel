...
Review, Tutor, and progress. Before each release, manually record the date, browser/device, tester,
and result for all rows below; link any discovered regression to its fix before approving release.

| Check          | Required evidence                                                                                                                               |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Keyboard       | Complete Login, create/edit/discard/delete, Review/repeat, Tutor, Me, and Logout without a pointer; verify focus order and restoration.         |
