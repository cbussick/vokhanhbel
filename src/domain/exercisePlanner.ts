 ...
 * no text, or that cannot find three distinct sibling backs in `pool`, plans as a flip Card
 * instead, and a would-be third consecutive multiple-choice Exercise is demoted to one too.
 *
